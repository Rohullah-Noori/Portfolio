...
function Resume() {
  const carddata = [
...

    {
      ...
      description:
        "I have successfully taught English  at this training center for a year.",
    },
    {
      dateIcon: <BiCalendar className="w-6 h-6 text-blue-400" />,
      date: "2023",
      degreeIcon: <GiGraduateCap className="w-6 h-6 text-blue-400" />,
      degree: " computer Teacher",
      locationIcon: <MdLocationOn className="w-6 h-6 text-blue-400" />,
      university: "Andisha Sazan Organization, Herat, Afghanistan",
      description:
        "I have successfully taught  computer at this training center for a year.",
    },
    {
      dateIcon: <BiCalendar className="w-6 h-6 text-blue-400" />,
      date: "2023",
    ...
    },
    {
      ...
      date: "2025",
      degreeIcon: <GiGraduateCap className="w-6 h-6 text-blue-400" />,
      degree: "frontend web development internship",
      locationIcon: <MdLocationOn className="w-6 h-6 text-blue-400" />,
      university: "Nareng Group",
      description:
        "Successfully completed a 3 months frontedn web  internship in Nareng Group",
    },
    {
      dateIcon: <BiCalendar className="w-6 h-6 text-blue-400" />,
      date: "2024",
  ...
  return (
    <div
      className="text-center text-white bg-black bg-center bg-no-repeat bg-cover py-15 "
      style={{ backgroundImage: `url(${image})` }}
    >
      <Container>
        <div className="items-center justify-center w-full px-5 py-5 text-center md:px-30 ">
          <h1 className="text-5xl font-bold">
            Resume (Education and Experiance)
          </h1>
        </div>
