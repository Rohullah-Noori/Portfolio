...
function SkillPage() {
  const SkillsCard = [
    {
      title: "HTML",
      titleIcon: <FaHtml5 className="w-20 h-20 text-blue-400" />,
    },
  ...
  return (
    <div className="mt-20 text-center text-white bg-black">
      <Container>
        ...
        <div className="grid w-full grid-cols-1 gap-6 p-4 cursor-pointer text-start sm:grid-cols-4 lg:grid-cols-4 md:p-5">
