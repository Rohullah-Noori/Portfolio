      ...
      <Container>
        <section className="flex flex-col p-4 md:flex-row">
          ...
          <div className="relative flex items-center justify-center w-full md:w-1/2">
            {/* بوردر نوارانی انیمیشنی */}
            <motion.div
              initial={{ scale: 1 }}
              animate={{ scale: [1, 1.1, 1], opacity: [0.6, 1, 0.6] }}
              transition={{ duration: 2, repeat: Infinity }}
              className="absolute border-4 border-blue-400 rounded-full w-72 h-72 blur-lg"
            />
            ...
            <motion.img
              ...
              src={image}
              alt="Hero"
              className="z-10 h-auto rounded-full shadow-lg min-w-1 outline-2 outline-blue-400 md:max-w-sm shadow-blue-400/20"
            />
          </div>
        </section>
      </Container>
