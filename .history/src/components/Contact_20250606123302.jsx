  ...
  return (
    <div className="mt-20 text-center text-white bg-black">
      <Container>
        ...
        {/* <div className="flex flex-col justify-center w-full mx-40 text-center md:flex-row">
          <motion.div
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-screen-xl mx-auto text-center md:flex-row">
          {/* دیو عکس */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: false, amount: 0.2 }}
            className="flex justify-center w-full bg-gray-100 md:w-1/2"
          >
