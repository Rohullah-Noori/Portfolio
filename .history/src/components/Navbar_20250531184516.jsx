      ...
      <Container>
        <div className="flex justify-end items-center p-4 ">
          <nav className="flex justify-between items-center w-full ">
            ...
            <ul
              className={`   md:flex md:space-x-4 text-white absolute md:static h-64 md:h-0  bg-black md:bg-transparent left-0 md:w-auto md:opacity-100 transition-all duration-300 ease-in-out  ${
