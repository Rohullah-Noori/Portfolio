  ...
  return (
    <div className="flex flex-col items-center justify-between h-full gap-6 p-4 ">
      <motion.div
        ...
        className="justify-center w-full h-full px-2 py-2 text-center text-blue-400 transition bg-gray-500 rounded-md hover:bg-blue-400 hover:text-white md:py-15 md:px-15 "
      >
