...
function SkillPage() {
  const SkillsCard = [
    ...
    { title: "FaBootstrap", titleIcon: <FaJsSquare className="w-20 h-20" /> },
    { title: "FaBootstrap", titleIcon: <FaReact className="w-20 h-20" /> },
    { title: "FaBootstrap", titleIcon: <SiNextdotjs className="w-20 h-20" /> },
    { title: "FaBootstrap", titleIcon: <FaWordpress className="w-20 h-20" /> },

    { title: "FaBootstrap", titleIcon: <FaGitAlt className="w-20 h-20" /> },
    { title: "FaBootstrap", titleIcon: <FaGithub className="w-20 h-20" /> },
  ];
