...
export function ServiceCard({ title, titleIcon }) {
  return (
    <div className="flex flex-col items-center justify-between h-full gap-6 p-4 ">
      <motion.div className="relative justify-center w-full h-full px-2 px-4 py-2 overflow-hidden text-center text-white transition bg-gray-500 rounded-md hover:bg-blue-400 md:py-15 md:px-15 group">
