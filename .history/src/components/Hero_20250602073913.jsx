...
import image from "../assets/heroo.jpg";
          ...
          <div className="flex flex-col items-center justify-center w-full mb-10 space-y-6 md:w-1/2 md:mb-0">
            ...
            <div className="flex pt-5 space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 font-bold text-blue-400 bg-transparent cursor-pointer md:px-6 md:py-3 outline-2 outline-blue-400 rounded-4xl hover:text-white"
              >
                <Link to="/contact">Contact me</Link>
              </motion.button>
            </div>
            <span className="flex gap-x-2">
              a <motion.FaGithub className="w-10 h-10 text-blue-400" />
              <motion.FaLinkedin className="w-10 h-10 text-blue-400" />
            </span>
          </div>

          <div className="relative flex items-center justify-center w-full pt-5 mb-15 md:pt-0 h-34 md:h-0 md:w-1/2">
            <motion.div
