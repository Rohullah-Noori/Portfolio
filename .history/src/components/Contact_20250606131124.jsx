...
function Contact() {
  const contactItem = [
    ...
    {
      icon: (
        <FaTelegramPlane className="text-2xl text-blue-400 transition-colors hover:text-blue-400" />
      ),
      title: "EMAIL",
      linkaddress: "#",
    },
    {
      icon: (
        <FaPhoneAlt className="text-2xl text-blue-400 transition-colors hover:text-green-800" />
      ),
      title: "PHONE",
      linkaddress: "#",
    },
