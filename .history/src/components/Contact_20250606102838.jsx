  ...
  return (
    <div className="mt-20 text-center text-white bg-black">
      <Container>
        ...
        <motion.section className="flex flex-col justify-center w-full min-h-screen gap-6 md:flex-row md:gap-8">
          <div
            className="flex justify-center  md:w-1/2 object-cover w-full max-w-md max-h-64 md:max-h-[500px] rounded-4xl md:block"
            style={image}
          >
