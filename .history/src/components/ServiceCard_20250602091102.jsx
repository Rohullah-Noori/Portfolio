  ...
  return (
    <div className="flex flex-col items-center justify-between h-full gap-6 p-4 r">
      <motion.div
        ...
        className="w-full h-full px-2 py-2 text-white align-middle transition border-2 border-t-0 border-l-0 rounded-md md:py-3 md:px-3 border-b-blue-400 border-r-blue-400 "
      >
