...
export function ServiceCard({ title, titleIcon, info }) {
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center w-full px-4 py-10 transition-colors duration-300 bg-blue-400 rounded-md"     boxShadow: "0 0 60px rgba(56, 189, 248, 0.9)">
        {titleIcon}
