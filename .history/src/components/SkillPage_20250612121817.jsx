...
function SkillPage() {
  ...
  return (
    <div
      className="mt-20 text-center text-white  bg-black bg-cover bg-center bg-no-repeat "
      style={{ background: `url(${image})` }}
    >
      <Container>
        <div className="items-center justify-center w-full px-5 py-5 text-center md:px-30 bg-black[50%] z-10">
