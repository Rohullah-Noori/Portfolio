      ...
      <Container>
        <div className="flex justify-end items-center p-4 ">
          <nav className="flex justify-between items-center w-full ">
            ...
            <ul
              className={`md:flex md:space-x-4 text-black absolute md:static bg-white md:bg-transparent left-0 md:w-auto md:opacity-100 transition-all duration-300 ease-in-out  ${open ?}`}
            >
              {Links.map((link) => (
                <li
                  key={link.name}
