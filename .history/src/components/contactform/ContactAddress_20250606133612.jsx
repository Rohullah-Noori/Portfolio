  ...
  return (
    <div className="w-full md:w-1/4 sm:w-1/2">
      ...
      <div
        ...
        className="w-[200px] h-[200px] bg-black border flex items-center justify-center text-center align-middle border-blue-200 rounded-full ring-2 ring-inset ring-blue-400"
      >
        {icon}
      </div>
