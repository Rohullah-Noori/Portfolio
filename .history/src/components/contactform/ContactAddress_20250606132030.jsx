function ContactAddress({ icon, title, linkaddress }) {
  return (
    <div className="flex flex-col items-center text-center gap-y-4 md:items-start md:text-left">
      ...
      <div
        className="p-4 mb-5 transition-all duration-300 bg-black border border-blue-200 rounded-full md:p-6 ring-2 ring-inset ring-blue-400 hover:ring-blue-300"
        style={{
