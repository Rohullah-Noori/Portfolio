    ...
    <div className="text-white bg-black ">
      <Container>
        <section className="flex flex-col items-center justify-between min-h-screen gap-6 p-4 md:flex-row">
          ...
          <div className="relative flex items-center justify-center w-full pt-5 pb-5 md:pt-0 h-34 md:h-0 md:w-1/2">
            <motion.div
            ...
            <motion.img
              src={image}
              alt="Hero"
              className="relative z-0 object-contain w-40 h-auto rounded-full shadow sm:w-56 md:w-72 shadow-sky-100"
            />
          </div>
        </section>
      </Container>
