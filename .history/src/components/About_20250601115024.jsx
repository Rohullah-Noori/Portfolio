        ...
        <section className="flex flex-col justify-center w-full min-h-screen gap-6 p-4 md:flex-row md:gap-8">
          ...
          <div className="w-full space-y-6 md:w-1/2">
            ...
            <p>
              ...
              specialize in WordPress design, creating fast and user-friendly
              websites tailored to client needs. With a blend of coding and
              design skills, I bring ideas to life across modern web platforms.
            </p>
