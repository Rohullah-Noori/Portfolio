...
function Card({ date, degree, university, description }) {
  return (
    <motion.div className="flex flex-col items-center justify-between gap-5 p-4 transition ">
      <div
        whileHover={{
          scale: 1.05,
          boxShadow: "0 0 60px rgba(56, 189, 248, 0.5)",
        }}
        className="w-full h-full px-5 py-5 text-gray-700 bg-blue-400 md:py-15 md:px-15 rounded-xl"
      >
