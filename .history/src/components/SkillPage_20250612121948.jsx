  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="grid w-full grid-cols-2 gap-6 p-4 cursor-pointer text-start sm:grid-cols-3 md:grid-cols-4 md:p-5 absolute inset-0 bg-black bg-opacity-60">
