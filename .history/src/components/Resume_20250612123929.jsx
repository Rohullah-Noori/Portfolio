...
import image from "../assets/exper.jpg";
...
function Resume() {
  ...
  return (
    <div
      className="text-center text-white bg-black  bg-cover bg-center bg-no-repeat"
    ...
    >
      <Container>
        ...
        <div className="grid w-full grid-cols-1 gap-6 p-4 cursor-pointer text-start md:grid-cols-2 md:p-5 bg-black opacity-50">
