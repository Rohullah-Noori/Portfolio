      ...
      <Container>
        <section className="flex flex-col p-4 md:flex-row">
          ...
          <div className="relative flex items-center justify-center w-full md:w-1/2">
            ...
            <motion.div
              className="absolute border border-blue-400 rounded-full w-30 h-30 sm:w-56 sm:h-56 md:w-72 md:h-72"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.7, 0.2, 0.7],
              }}
              ...
              style={{
                boxShadow: "0 0 30px 30px rgba(96, 165, 250, 0.5)",
              }}
            />
            ...
            <motion.img
              src={image}
              alt="Hero"
              className="relative z-10 w-40 h-auto rounded-full shadow sm:w-56 md:w-72 shadow-sky-100"
