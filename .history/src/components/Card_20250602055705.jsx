  ...
  return (
    <div className="flex flex-col items-center justify-between h-full gap-6 p-4 r">
      <motion.div
        ...
        className="w-full h-full px-2 py-2 text-white transition border-2 border-t-0 border-l-0 rounded-md shadow-[inset_0_0_0_2px_rgba(56,189,248,0.5)] border-b-blue-4100 border-r-blue-4100 "
      >
        ...
        <h1 className="flex items-center pb-3 text-2xl font-semibold text-blue-400 gap-x-2">
